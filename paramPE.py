...
gene_list_file ="/home/mayere/Analyse_RNAseq/Analysis/TF_discovery/TF_discov/Gene_list_EPI_vs_PE_50avgdiff.txt"
...
jsonFile = 'resulstJsonPE.json'
TSVFilse = 'results_tsvPE.txt'
